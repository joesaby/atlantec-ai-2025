    ...
    <div className="space-y-4">
      ...
      <div className="alert alert-info shadow-lg mb-6">
        ...
        <div>
          ...
          <div className="text-sm">
            Set goals, track progress, and get personalized sustainable practice
            recommendations.
          </div>
        </div>
      </div>
      ...
      <div className="p-1">
        ...
        {activeTab === "add" && (
          <div>
            <h2 className="text-xl font-bold mb-4">
              Sustainable Practices for Irish Gardens
            </h2>
            <p className="mb-4">
              Browse and select sustainable gardening practices suited for Irish
              climate and conditions. Each practice contributes to your
              sustainability score and helps you garden more responsibly.
            </p>
        ...
        {activeTab === "recommendations" && (
          <div>
            ...
            <p className="mb-4">
              Based on your current practices, local Irish conditions, and the
              current season, here are sustainable practices we recommend to
              enhance your green gardening journey.
            </p>
