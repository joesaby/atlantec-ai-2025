...
interface DashboardData {
  ...
  carbonTrend: any;
  sdgImpact: any;
  waterChange: ChangeMetric;
  compostChange: ChangeMetric;
  harvestChange: ChangeMetric;
  carbonChange: ChangeMetric;
}
...
const SustainabilityDataVisualization = () => {
  ...
  const [selectedTimeframe, setSelectedTimeframe] =
    useState<TimeframeOption>("month");
        ...
        <div className="card bg-base-200 shadow-sm">
          <div className="card-body">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <div
                className={`badge ${
                  dashboardData.waterChange.isPositive
                    ? "badge-error"
                    : "badge-success"
                }`}
              >
                {dashboardData.waterChange.isPositive ? "↑" : "↓"}{" "}
                {Math.abs(dashboardData.waterChange.percentage)}%
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-200 shadow-sm">
          <div className="card-body">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <div
                className={`badge ${
                  dashboardData.carbonChange.isPositive
                    ? "badge-success"
                    : "badge-error"
                }`}
              >
                {dashboardData.carbonChange.isPositive ? "↑" : "↓"}{" "}
                {Math.abs(dashboardData.carbonChange.percentage)}%
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="card bg-base-200 shadow-sm">
          <div className="card-body">
            ...
            <div className="flex justify-between items-center mt-2">
              ...
              <div
                className={`badge ${
                  dashboardData.harvestChange.isPositive
                    ? "badge-success"
                    : "badge-error"
                }`}
              >
                {dashboardData.harvestChange.isPositive ? "↑" : "↓"}{" "}
                {Math.abs(dashboardData.harvestChange.percentage)}%
              </div>
            </div>
          </div>
        </div>
