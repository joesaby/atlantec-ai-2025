    ...
    <div className="card bg-base-100 shadow-xl">
      <div className="card-body p-4">
        <h3 className="card-title text-lg flex items-center justify-between">
          ...
          <div className="badge badge-accent">{metrics.sustainabilityScore}/5</div>
        </h3>
        ...
        <div className="stats bg-primary text-primary-content shadow mb-4">
          <div className="stat">
            ...
            <div className="stat-value text-lg">{metrics.totalCarbonSavings} kg</div>
        ...
        {metrics.sdgs.length > 0 && (
          <div className="mb-4">
            <h4 className="font-semibold text-sm mb-1">Supports UN Sustainable Development Goals:</h4>
            <div className="flex flex-wrap gap-1">
              {metrics.sdgs.map(sdgId => (
                ...
                >
                  <div className="badge badge-outline gap-1" style={{ borderColor: sdgGoals[sdgId].color }}>
            ...
            <div className="alert alert-info mt-4 p-3">
              ...
              <div className="text-xs">
                ...
                <ul className="list-disc list-inside mt-1">
                  <li>{(metrics.totalCarbonSavings * 4).toFixed(2)} car miles</li>
                  <li>{(metrics.totalCarbonSavings / 25).toFixed(2)} tree-months of carbon sequestration</li>
                </ul>
              </div>
            </div>
