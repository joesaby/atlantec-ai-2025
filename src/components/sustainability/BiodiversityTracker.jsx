    ...
    <div className="bg-base-100 rounded-lg shadow-lg p-6 mb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              <div className="bg-base-100 p-3 rounded-lg flex items-center">
                ...
                <div>
                  ...
                  <span className="text-xs opacity-70">Beneficial Insects</span>
                </div>
              </div>
      ...
      <div className="mt-6 bg-base-200 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          {!activePracticeIds.some(
            ...
            <div className="bg-base-100 p-3 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">
                  Plant Irish wildflowers like clover, knapweed, and bird's-foot
                  trefoil to support bees
                </p>
                <p className="text-xs mt-1 text-success">
          ...
          {!activePracticeIds.some((id) => id.includes("water-feature")) && (
            <div className="bg-base-100 p-3 rounded-lg flex items-start gap-3">
              <div className="text-2xl">💧</div>
              <div>
          ...
          {biodiversityPractices.length >= 4 && (
            <div className="bg-base-100 p-3 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm opacity-80">
                  Take photos of wildlife in your garden and log the species you
                  observe
                </p>
              </div>
            </div>
      ...
      <div className="mt-6">
        ...
        <div className="mt-3 p-3 bg-warning bg-opacity-10 rounded-lg border border-warning">
          <p className="text-sm font-medium text-warning-content">
            <span className="font-bold">Did you know?</span> 35% of Ireland's 98
            native bee species are at risk of extinction. Your garden can make a
            real difference in helping to protect them.
          </p>
        </div>
      </div>
    </div>
