  ...
  const filteredRecommendations =
    seasonalFilter === "all"
      ...
      : recommendations.filter((rec) => {
          ...
          return seasonKeywords[seasonalFilter]?.some((keyword) =>
    ...
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        <h3 className="text-lg font-semibold">
          Recommended Practices for Your Garden
        </h3>
        <div className="dropdown dropdown-end">
          <label tabIndex={0} className="btn btn-sm m-1">
            {seasonalFilter === "all"
              ? "All Seasons"
              : seasonalFilter.charAt(0).toUpperCase() +
                seasonalFilter.slice(1)}
            <svg
              xmlns="http://www.w3.org/2000/svg"
          ...
          >
            <li>
              <a onClick={() => setSeasonalFilter("all")}>All Seasons</a>
            </li>
            <li>
              <a onClick={() => setSeasonalFilter("spring")}>Spring</a>
            </li>
            <li>
              <a onClick={() => setSeasonalFilter("summer")}>Summer</a>
            </li>
            <li>
              <a onClick={() => setSeasonalFilter("autumn")}>Autumn</a>
            </li>
            <li>
              <a onClick={() => setSeasonalFilter("winter")}>Winter</a>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {filteredRecommendations.map((recommendation) => (
          <div
            key={recommendation.practice.id}
            className="card bg-base-100 shadow-md hover:shadow-lg border-l-4 border-primary"
          >
            <div className="card-body p-4">
              <div className="flex items-center gap-2 mb-1">
                <div className="badge badge-primary">
                  {recommendation.practice.category}
                </div>
              ...
              <div className="card-actions justify-end mt-3">
                <a
                  href="/sustainability-tracker?action=add-practice&id={recommendation.practice.id}"
