            ...
            <div className="bg-base-200 p-4 rounded-lg">
              ...
              {specificImpact ? (
                <>
                  ...
                  {specificImpact.sdgImpacts && (
                    <div className="mt-4">
                      <h4 className="font-semibold mb-2">
                        UN SDG Contributions:
                      </h4>
                      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2">
                        {Object.entries(specificImpact.sdgImpacts)
                          .filter(([_, value]) => value > 0)
                          .sort(([_, a], [__, b]) => b - a)
                          .slice(0, 6) // Show top 6 contributions
                          .map(([sdgKey, value]) => {
                            ...
                            return (
                              <div
                                key={sdgKey}
                                className="tooltip flex items-center gap-1 p-2 rounded-md"
